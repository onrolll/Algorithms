...
class BinaryMinHeap:
    ...
    def _heapify_down(self, index):
        # TODO: figure out why commented lines do not work 
        ...
        while True:
            ...
            if len(self.heap) <= left:
                break
            left_key = self.heap[left]
            right = left + 1
            right_key = len(self.heap) > right and self.heap[right]
